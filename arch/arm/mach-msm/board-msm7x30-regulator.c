...
#if defined(CONFIG_MACH_MSM8X55_VICTOR) /* external micro sd card */
	PCOM_VREG_LDO(ldo10,  7, NULL,  2600000,  3000000, 0, -1, 0, 0, 0, 0),
#else
	PCOM_VREG_LDO(ldo10,  7, NULL,  2850000,  2850000, 0, -1, 0, 0, 0, 0), /* LGE_UPDATE 20120206 sunny.jang@lge.com 2600000 --> 2850000 */
#endif
	PCOM_VREG_LDO(ldo11, 21, NULL,  2800000,  2800000, 0, -1, 0, 0, 0, 0),  /* MIPI Camera & VGA Camera Digial block power */
	PCOM_VREG_LDO(ldo12, 34, NULL,  2800000,  2800000, 0, -1, 0, 0, 0, 0),  /* MIPI Camera & VGA Camera Analog block power */
#if defined(CONFIG_MACH_MSM8X55_VICTOR)
	PCOM_VREG_LDO(ldo13, 15, NULL,  2600000,  2850000, 0, -1, 0, 0, 0, 0),
#else
	PCOM_VREG_LDO(ldo13, 15, NULL,  2900000,  3050000, 0, -1, 0, 0, 0, 0),
#endif
#if defined(CONFIG_MACH_MSM8X55_VICTOR) /* Antena select AND gate, WCDMA RF, PAM, etc */
	PCOM_VREG_LDO(ldo14, 24, NULL,  2600000,  2850000, 0, -1, 0, 0, 0, 0),
#else
	PCOM_VREG_LDO(ldo14, 24, NULL,  2600000,  2600000, 0, -1, 0, 0, 0, 0),
#endif
#if defined(CONFIG_MACH_MSM8X55_VICTOR)
	PCOM_VREG_LDO(ldo15, 23, NULL,  3000000,  3000000, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(ldo16, 35, NULL,  1800000,  1800000, 0, -1, 0, 0, 0, 0),
#else
...
#if defined(CONFIG_MACH_MSM8X55_VICTOR)
	PCOM_VREG_LDO(ldo19, 45, NULL,  1800000,  1800000, 0, -1, 0, 0, 0, 0),
#else
	PCOM_VREG_LDO(ldo19, 45, NULL,  2600000,  2600000, 0, -1, 0, 0, 0, 0),
#endif
#if defined(CONFIG_MACH_MSM8X55_VICTOR)
	PCOM_VREG_LDO(ldo20, 38, NULL,  1500000,  1800000, 0, -1, 0, 0, 0, 0),
#else
	PCOM_VREG_LDO(ldo20, 38, NULL,  3300000,  3300000, 0, -1, 0, 0, 0, 0),
#endif
