...
// QCT Case #01190708
// To avoid this we need to allocate separate dma channels to sd card and eMMC. Please do as follows:
// If you are not using TSIF module then channel 10 will be unused, so we can allocate this to SD CARD.
// #define DMOV_SDC4_CHAN        8
#define DMOV_SDC4_CHAN        10
