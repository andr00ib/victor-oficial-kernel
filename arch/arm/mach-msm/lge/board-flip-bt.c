...
static int flip_bluetooth_toggle_radio(void *data, bool state)
{
	int ret;
...
static int flip_bluetooth_power(int on)
{
	int pin, rc;
...
static struct bluetooth_platform_data flip_bluetooth_data = {
	.bluetooth_power = flip_bluetooth_power,
	.bluetooth_toggle_radio = flip_bluetooth_toggle_radio,
};
...
static struct platform_device msm_bt_power_device = {
	...
	.id = -1,
	.dev = {
		.platform_data = &flip_bluetooth_data,
	},
};
...
static struct bluesleep_platform_data flip_bluesleep_data = {
...
static struct platform_device msm_bluesleep_device = {
	...
	.dev = {
		.platform_data = &flip_bluesleep_data,
	},
};
