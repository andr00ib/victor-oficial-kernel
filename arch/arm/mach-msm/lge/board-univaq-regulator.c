...
static struct proccomm_regulator_info univaq_pcom_vreg_info[] = {
	...
	PCOM_VREG_LDO(ldo12, 34, NULL,  2800000,  2800000, 0, -1, 0, 0, 0, 0),
...
struct proccomm_regulator_platform_data univaq_proccomm_regulator_data = {
	.regs = univaq_pcom_vreg_info,
	.nregs = ARRAY_SIZE(univaq_pcom_vreg_info)
};
