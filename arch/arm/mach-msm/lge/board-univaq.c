...
/* LGE_UPDATE_S youngrok.song@lge.com 20110201 UnivaQ VREG constraints */
extern struct proccomm_regulator_platform_data univaq_proccomm_regulator_data;
/* LGE_UPDATE_E youngrok.song@lge.com 20110201 UnivaQ VREG constraints */
static struct platform_device msm_proccomm_regulator_dev = {
	.name = PROCCOMM_REGULATOR_DEV_NAME,
	.id   = -1,
	.dev  = {
	/* LGE_UPDATE youngrok.song@lge.com 20110201 UnivaQ VREG constraints */
		.platform_data = &univaq_proccomm_regulator_data
...
static struct platform_device *devices[] __initdata = {
#ifdef CONFIG_MSM_PROC_COMM_REGULATOR
	&msm_proccomm_regulator_dev,   /* LGE_UPDATE kideok.kim@lge.com 20111216 kernel 3.0.x Adaptation */
#endif
	&asoc_msm_pcm,
	&asoc_msm_dai0,
	&asoc_msm_dai1,
	...
	&msm_device_ssbi_pmic1,  /* LGE_UPDATE kideok.kim@lge.com 20111216 kernel 3.0.x Adaptation */
#endif
#ifdef CONFIG_I2C_SSBI
/*	&msm_device_ssbi6,  */ /* LGE_UPDATE 20111216 kideok.kim@lge.com kernel 3.0.x Adaptation */
	&msm_device_ssbi7,
#endif
	&msm_device_i2c,
	&msm_device_i2c_2,
...
static struct msm_i2c_platform_data qup_i2c_pdata = {
	.clk_freq = 384000,
/*	.pclk = "camif_pad_pclk",   */ /* LGE_UPDATE kideok.kim@lge.com kernel 3.0 migration */
...
static void __init msm7x30_init(void)
{
	...
	msm_add_fb_device();
	msm_add_kgsl_device();     /* LGE_UPDATE kideok.kim@lge.com 20111216 device data was changed at kernel 3.0.x */ 
...
/* LGE_UPDATE_S kideok.kim@lge.com 20111216 kernel 3.0.x Adaptation */
	pmic8058_leds_init();	 // LGE_UPDATE kideok.kim@lge.com. PMIC LED Control Drv.

	pmic8058_buses_init();

/*  Move to board-univaq-pm.c */
/*
#ifdef CONFIG_MSM_SSBI
...
#ifdef CONFIG_I2C_SSBI
/*	msm_device_ssbi6.dev.platform_data = &msm_i2c_ssbi6_pdata; */ /* LGE_UPDATE 20111216 kideok.kim@lge.com kernel 3.0.x Adaptation */
...
{
/* LGE_UPDATE_S youngrok.song@lge.com QCT404032I patch */
/* LGE_UPDATE_S kideok.kim@lge.com Kernel 3.X Adaptation */
#if 0
	if (paddr < 0x40000000)
		return MEMTYPE_EBI0;
	...
	*/
#endif	
/* LGE_UPDATE_E kideok.kim@lge.com Kernel 3.X Adaptation */
/* LGE_UPDATE_E youngrok.song@lge.com QCT404032I patch */
...
/* LGE_UPDATE_S kideok.kim@lge.com 20111216 kernel 3.0.x Adaptation */
/* It moved from board-univaq.c ... poor coding rule ..*/
