...
//slgi97.park@lge.com 2013/03/18
...
#else
#if 1 //def CONFIG_LGE_HANDLE_PANIC //vegito@lge.com
	if (restart_reason == CRASH_REBOOT)
...
//20130330 seongjun.cho@lge.com power off charging 
		}
 ...
 *      0: success
 */
// idle wake lock 10s Start [
// jeong.min.kim 2013-06-15
static struct wake_lock idle_lock;
// ] idle wake lock 10s End
...
// jeong.min.kim 2013-06-15
    {
        wake_lock_init(&idle_lock, WAKE_LOCK_IDLE, "pm_init_idle");
        wake_lock_timeout(&idle_lock, 10 * HZ);
    }
// ] idle wake lock 10s End
