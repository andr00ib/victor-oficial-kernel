...
/* LGE_CHANGE_S, dohwan.an@lge.com , kernel null pointer error after Modem build id force set. */
/* if you use original code and debugging message, you will see success message */
/* This is temporary code for prevent to error. need delay?? */
#if defined (CONFIG_MACH_LGE)
		MM_INFO("[LGE] Waiting for call back events\n");
#else
