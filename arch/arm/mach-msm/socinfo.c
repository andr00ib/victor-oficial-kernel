...
{
	/* LGE_CHANGE_S, bk.seol@lge.com , 2012-02-24, Modem build id force set */
	/* LGE modem does not set Qualcomm build version, so insert qualcomm build id for audio */
	/* If modem build version from 4040 to 41XX, Must change this */
#if defined(CONFIG_MACH_LGE)
	if(socinfo)
		strcpy(socinfo->v1.build_id, "7X30A-AABBQOLYM-40000230");
#endif
	/* LGE_CHANGE_E, bk.seol@lge.com , 2012-02-24 */
