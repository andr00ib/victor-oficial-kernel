...
gp2ap_i2c_remove(struct i2c_client *client)
{
	...
	irq_set_irq_wake(gp2ap_pdev->irq, 0); /* LGE_UPDATE 20111216 kideok.kim@lge.com kernel 3.0.x Adaptation */
...
gp2ap_suspend(struct i2c_client *i2c_dev, pm_message_t state)
{
	...
	irq_set_irq_wake(pdev->irq, 0); /* LGE_UPDATE 20111216 kideok.kim@lge.com kernel 3.0.x Adaptation */
