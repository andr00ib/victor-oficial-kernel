...
void check_chip_calibration(void)
{
	...
	{	
		config_byte = 20;
		multi_touch_T9_address = get_object_address(TOUCH_MULTITOUCHSCREEN_T9,0);
		write_mem(multi_touch_T9_address+7,1,&config_byte);
...
//	set_bit(KEY_SEARCH, qt602240->input_dev->keybit);
	...
	set_bit(INPUT_PROP_DIRECT, qt602240->input_dev->propbit);
