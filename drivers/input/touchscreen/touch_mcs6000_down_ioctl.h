...
#define MCS6000_TS_DOWN_IOCTL_ENTER_DOWN_MODE	_IO( MCS6000_TS_DOWN_IOCTL_MAGIC, 16)

#define MCS6000_TS_DOWN_IOCTL_SELECT_TS_TYPE 	_IOW( MCS6000_TS_DOWN_IOCTL_MAGIC, 17, int )

#define MCS6000_TS_DOWN_IOCTL_CE_HIGH		_IO( MCS6000_TS_DOWN_IOCTL_MAGIC, 18)
#define MCS6000_TS_DOWN_IOCTL_CE_LOW		_IO( MCS6000_TS_DOWN_IOCTL_MAGIC, 19)
