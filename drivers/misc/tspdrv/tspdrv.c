...
#else   /* temporary */
static long immersion_vibrator_ioctl(struct file *file, unsigned int cmd, unsigned long arg);
#endif
...
/*    .ioctl =    immersion_vibrator_ioctl,  */   /* Temporary */
    .unlocked_ioctl =    immersion_vibrator_ioctl,
