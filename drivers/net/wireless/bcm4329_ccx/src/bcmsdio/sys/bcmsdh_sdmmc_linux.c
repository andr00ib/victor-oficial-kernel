...
/* LGE_CHANGE_S, 2011-0726, [real-wifi@lge.com by kyungeho.kim], dtim change for suspend current */
...
/*LGE_CHANGE_S, 2011-0726, [real-wifi@lge.com by kyunghoekim], dtim change for suspend current */
#if defined(CONFIG_LGE_BCM432X_PATCH) /* dtim change for suspend current */
...
dhd_enable_hwakeup(void)
{
	...
	ret = irq_set_irq_wake(dhd_wifi_sleep->host_wake_irq, 1); /* LGE_UPDATE kideok.kim@lge.com 20111216 kernel 3.0.x Adaptation */
...
{
	if (irq_set_irq_wake(dhd_wifi_sleep->host_wake_irq, 0)) /* LGE_UPDATE kideok.kim@lge.com 20111216 kernel 3.0.x Adaptation */
