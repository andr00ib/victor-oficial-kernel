...
#ifdef BCMCCX								/* LGE_CHANGE_S, 2011-0226, add CCX */
		if(var_int)
...
/* LGE_CHANGE_S, [real-wifi@lge.com by kyunghoe.kim], 2011-0826, support roaming */
	// int arp_ol = 0xf;
	int arp_ol = 0xb;
	//int scan_assoc_time = 40;
	//int scan_unassoc_time = 80;
	//const char *str;
/* LGE_CHANGE_E, [real-wifi@lge.com by kyunghoe.kim], 2011-0826, support roaming */

#ifndef BCMCCX								/* LGE_CHANGE_S, 2011-0226, add CCX */
	int scan_assoc_time = 40;
	int scan_unassoc_time = 80;
#endif										/* LGE_CHANGE_S, 2011-0226, add CCX */
	const char 				*str;
...
#if defined(BCMCCX) && (BCMDBG_EVENT) /* junlim */								/* LGE_CHANGE_S, 2011-0226, add CCX */
	setbit(eventmask, WLC_E_DEBUG_EVENT);
	setbit(eventmask, WLC_E_ADDTS_IND);
	setbit(eventmask, WLC_E_DELTS_IND);
#endif /* defined(BCMCCX) && (BCMDBG_EVENT) */ /* junlim */							/* LGE_CHANGE_E, 2011-0226, add CCX */
