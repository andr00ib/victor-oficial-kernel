...
int bcmsdh_register_oob_intr(void * dhdp)
{
	...
	if (!sdhcinfo->oob_irq_registered) {
		...
		irq_set_irq_wake(sdhcinfo->oob_irq, 1);  /* LGE_UPDATE kideok.kim@lge.com 20111216 kernel 3.0.x Adaptation */
...
void bcmsdh_set_irq(int flag)
{
	if (sdhcinfo->oob_irq_registered) {
		...
		if (flag) {
			...
			irq_set_irq_wake(sdhcinfo->oob_irq, 0); /* LGE_UPDATE kideok.kim@lge.com 20111216 kernel 3.0.x Adaptation */
