...
// junglark.park@lge.com: wbt
// Buffer overflow, array index of 'cmd' may be out of bounds. Array 'cmd' of size 6 may use index value(s) 8.
// Also there is one similar error on line 287
   u_char cmd[9]; // cmd[6] -> cmd[9] changed.
