...
//  junglark.park@lge.com [S] : Buffer overflow, array index of 'cmd' may be out of bounds. 
//    Array 'cmd' of size 12 may use index value(s) 0..262
    buff_len =  sizeof(cdb);
    if( len  > buff_len )
        len = buff_len;
//  junglark.park@lge.com [E]
