...
//LGE_UPDATE_S minhobb2.kim@lge.com for MTCall Backlight on
int saved_backlight_level = 0;
//LGE_UPDATE_E minhobb2.kim@lge.com for MTCall Backlight on
...
#endif
//LGE_UPDATE_E minhobb2.kim@lge.com for univaq RevB MainBL			
...
//LGE_UPDATE_S minhobb2.kim@lge.com for sleep current setting
	lm3530_sleep(drvdata);
	lm3530_poweroff(drvdata);
//LGE_UPDATE_E minhobb2.kim@lge.com for sleep current setting
	return;
}
