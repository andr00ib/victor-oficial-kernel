...
//LGE_UPDATE_S minhobb2.kim@lge.com for fixing lcd sleep current
		mddi_host_client_cnt_reset();
//LGE_UPDATE_E minhobb2.kim@lge.com for fixing lcd sleep current
...
static ssize_t mddi_auo_lcd_store_onoff(struct platform_device *pdev, struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if(onoff) {
//LGE_UPDATE_S minhobb2.kim@lge.com for ATCMD
#if 0
		is_lcd_on = TRUE;
...
#endif
//LGE_UPDATE_E minhobb2.kim@lge.com for ATCMD		
	}
	else {
//LGE_UPDATE_S minhobb2.kim@lge.com for ATCMD
#if 0
...
static void mddi_auo_lcd_panel_poweron(void)
{
	...
	if(pdata && pdata->gpio) {
//LGE_UPDATE_S minhobb2.kim@lge.com for RevA Main LCD RST
#if 0
		...
		mdelay(20);
#endif
//LGE_UPDATE_E minhobb2.kim@lge.com for RevA Main LCD RST	
	}
}
