...
//LGE_UPDATE_S minhobb2.kim@lge.com for start rending log
extern int start_drawing_flag;
//LGE_UPDATE_E minhobb2.kim@lge.com for start rending log
...
/*LGE_UPDATE_S youngrok.song QCT404032I patch*/
#ifndef CONFIG_FB_MSM_LCDC_LGDISPLAY_WVGA_OLED 
	static int subsys_id[2] = {MSM_SUBSYSTEM_DISPLAY,
		MSM_SUBSYSTEM_ROTATOR};
	unsigned int flags = MSM_SUBSYSTEM_MAP_IOVA;
#endif
/*LGE_UPDATE_E youngrok.song QCT404032I patch*/
