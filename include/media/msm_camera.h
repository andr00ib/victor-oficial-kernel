...
//[LGE_UPDATE_S] minhobb2.kim@lge.com 2011-01-26 : add video recording flash
#define MSM_CAMERA_LED_TORCH 5
//[LGE_UPDATE_E] minhobb2.kim@lge.com 2011-01-26 
...
//20120209 mina.park : Build Error Fixed in Kernel 3.0 */
#if 0
...
#define CFG_HW_REV		36
/* LGE_UPDATE_S kideok.kim@lge.com 20120209 e739,c800 ics one src */
#if defined(CONFIG_MACH_MSM8X55_VICTOR)|| defined(LGE_VICTOR)
#define CFG_SET_SCENE                   37  // donghyun.kwon(20110502) ; add scene mode for VGA
#define CFG_SET_EXPOSURE_VALUE	        38  // donghyun.kwon(20110505) : add exposure compensation for VGA
#define CFG_MAX				39
#else
#define CFG_MAX				37
#endif
...
#define CAMERA_MSM_BESTSHOT_OFF	0
//jueul.jang@lge.com 2013-05-02 : modify night mode index for e730 ICS upgrade
//#define CAMERA_MSM_BESTSHOT_NIGHT	5
#define CAMERA_MSM_BESTSHOT_NIGHT	6
...
#if defined(CONFIG_MACH_MSM8X55_VICTOR)|| defined(LGE_VICTOR)
/* 20120209 mina.park LGE_CHANGE_S : Build Error Fixed in Kernel 3.0 */
...
#define  CAMERA_WB_TWILIGHT           7
#define  CAMERA_WB_SHADE              8
/* 20120209 mina.park LGE_CHANGE_E : Build Error Fixed in Kernel 3.0 */
#endif
