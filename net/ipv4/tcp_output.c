...
// LGE_CHANGE_S, [LGE_DATA_US_008] d3sw1-data@lge.com, 2012-10-16 <Define MTU Size 1440 for TMUS>
	mss = 1410; 
	tp->advmss = mss;
// LGE_CHANGE_E, [LGE_DATA_US_008] d3sw1-data@lge.com, 2012-10-16 <Define MTU Size 1440 for TMUS>
	return (__u16)mss;
}
